import sys
sys.path.append("..")
from bert.vpipe import Stage
from bert.vpipe import Bert
...
def model(criterion, partition, recompute_ratio):
    ...
    bert = Bert(_declares, _calculations)
    bert.generate_layer_blocks()
    start = 0
    inputs = []
    outputs = [['out250']]
    all_outputs = []
    ...
    calculations = []
    for i in partition:
        stage = bert.generate_stage(start, start + i)
        start += i
